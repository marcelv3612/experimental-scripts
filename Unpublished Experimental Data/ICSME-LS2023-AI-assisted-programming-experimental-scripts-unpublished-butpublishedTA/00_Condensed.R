...
colnames(data) = c('ID', 'Start_time', 'Completion_time', 'Email','Name',
                   ...
                   '03_06', '03_07', '03_Role', '03_Helped', '03_Duration',
                   '04_01', '04_02', '04_03', '04_04', '04_05',
                   '04_06', '04_07', '04_Role', '04_Helped', '04_Duration',
                   '05_01', '05_02', '05_03', '05_04', '05_05',
                   '05_06', '05_07', '05_Role', '05_Helped', '05_Duration',
                   '06_01', '06_02', '06_03', '06_04', '06_05',
                   '06_06', '06_07', '06_Role', '06_Helped', '06_Duration',
                   'Ps_results_flag', 'Initials'
)

# factorize values by changing it to numbers
for (i in 9:58){
  if (length(grep("Duration",colnames(data)[i])) == 0) {
  ...
  if (length(grep("Role",colnames(data)[i])) == 0) {
    ...
    levels(data[,i]) = c('GPT3.5','GPT4','Solo','CoPilot','X')
  }
}
...
data$Exc_round = ceiling((data$Start_time -  44988)/7)
# data$Exc_round = ifelse(data$Exc_round == 7, 3, data$Exc_round)


x <- c(60, 41, 79, 80, 85, 67, 57, 54, 38, 71)
mean(x)
sd(x)
...
Stats = data.frame(Start_time = Start_time,
                   ...
                   B5_O = (6 - `01_05`) + `01_10`, 6 - 1 + 3 = 8
                   B5_C = (6 - `01_03`) + `01_08`, 6 - 2 + 4 = 8
                   B5_E = (6 - `01_01`) + `01_06`, 6 - 4 + 2 = 4
                   B5_A = `01_02` + (6 - `01_07`), 6 - 2 + 2 = 6
                   B5_N = (6 - `01_04`) + `01_09`, 6 - 2 + 4 = 8
                   ...
                   Helped_01 = `03_Helped`, Helped_02 = `04_Helped`, Helped_03 = `05_Helped`,
                   Helped_04 = `06_Helped`,
                   
                   Duration_01 = `03_Duration`, Duration_02 = `04_Duration`, Duration_03 = `05_Duration`,
                   Duration_04 = `06_Duration`,
                   )
detach(data)
